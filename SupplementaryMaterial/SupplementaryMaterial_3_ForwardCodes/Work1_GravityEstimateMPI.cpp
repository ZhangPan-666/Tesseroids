// This cpp file is an example paralle calculation (MPI based) script for 
...
// The core subfunction called by this script is named Tesseroid_GravityEstimateMPI. 
// For the definition of the input and output of this function, please refer to line 166.
...
int main(int argc, char** argv)
{
	...
	// "Tesseroid_GravityEstimateMPI" is a function that calculates the gravitational field and its derivatives of spherical prisms in 
	// parallel mode.
	// 
	// Input Parameters:
	// 
	...
	mista_math::Tesseroid_GravityEstimateMPI(NumDensityModel, Fai1, Fai2, Lamda1, Lamda2, R1, R2, rho,
