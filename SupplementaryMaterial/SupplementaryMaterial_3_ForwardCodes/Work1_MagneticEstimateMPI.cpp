 //This cpp file is an example parallel calculation (MPI based) script for 
 ...
 //The core subfunction called by this script is named Tesseroid_MagneticEstimateMPI. 
 //For the definition of the input and output of this function, please refer to line 154.
...
int main(int argc, char** argv)
{
	...
	Mx = (double*)malloc(sizeof(double) * NumDensityModel);
	My = (double*)malloc(sizeof(double) * NumDensityModel);
	Mz = (double*)malloc(sizeof(double) * NumDensityModel);
	...
	// "Tesseroid_MagneticEstimateMPI" is a function that calculates the magnetic field and its derivatives of spherical prisms in 
	// parallel mode.
	// 
	// Input Parameters:
	// 
	...
	mista_math::Tesseroid_MagneticEstimateMPI(NumDensityModel, Fai1, Fai2, Lamda1, Lamda2, R1, R2, Mx, My, Mz,
