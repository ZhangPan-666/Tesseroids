...
// The core subfunction called by this script is named Tesseroid_GravityEstimateOpenMP. 
// For the definition of the input and output of this function, please refer to line 155.
...
int main(int argc, char** argv)
{
	...
	// "Tesseroid_GravityEstimateOpenMP" is a function that calculates the gravitational field and its derivatives of spherical prisms in 
	// parallel mode.
	// 
	// Input Parameters:
	// 
	...
	mista_math::Tesseroid_GravityEstimateOpenMP(NumDensityModel, Fai1, Fai2, Lamda1, Lamda2, R1, R2, rho,
