// This cpp file is an example parallel calculation (OpenMP based) script for 
...
// The core subfunction called by this script is named Tesseroid_MagneticEstimateOpenMP. 
...
int main(int argc, char** argv)
{
	...
	// "Tesseroid_MagneticEstimateOpenMP" is a function that calculates the magnetic field and its derivatives of spherical prisms in 
	// parallel mode.
	// 
	// Input Parameters:
	// 
	...
	mista_math::Tesseroid_MagneticEstimateOpenMP(NumDensityModel, Fai1, Fai2, Lamda1, Lamda2, R1, R2, Mx, My, Mz,
