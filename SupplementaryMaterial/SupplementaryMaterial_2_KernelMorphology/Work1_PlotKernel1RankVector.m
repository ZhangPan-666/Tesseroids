...
KernelVx=Tesseroid_IntegralkernelVx(R2,R1,Latitude,Longitude,r,fai,lamda);

%%

KernelVy=Tesseroid_IntegralkernelVy(R2,R1,Latitude,Longitude,r,fai,lamda);

%%

KernelVz=Tesseroid_IntegralkernelVz(R2,R1,Latitude,Longitude,r,fai,lamda);
