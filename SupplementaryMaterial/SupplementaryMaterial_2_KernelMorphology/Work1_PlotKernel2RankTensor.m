...
KernelVxx=Tesseroid_IntegralkernelVxx(R2,R1,Latitude,Longitude,r,fai,lamda);

%%

KernelVxy=Tesseroid_IntegralkernelVxy(R2,R1,Latitude,Longitude,r,fai,lamda);

%%

KernelVyy=Tesseroid_IntegralkernelVyy(R2,R1,Latitude,Longitude,r,fai,lamda);

%%

KernelVzx=Tesseroid_IntegralkernelVzx(R2,R1,Latitude,Longitude,r,fai,lamda);

%%

KernelVzy=Tesseroid_IntegralkernelVzy(R2,R1,Latitude,Longitude,r,fai,lamda);

%%

KernelVzz=Tesseroid_IntegralkernelVzz(R2,R1,Latitude,Longitude,r,fai,lamda);
