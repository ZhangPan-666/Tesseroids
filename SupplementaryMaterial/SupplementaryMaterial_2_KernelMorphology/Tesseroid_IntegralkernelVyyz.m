function [KernelVyyz]=Tesseroid_IntegralkernelVyyz(R2,R1,FaiI,LamdaI,r,fai,lamda)
...
if R2<1
    KernelVyyz(Index1)=cosd(FaiI(Index1))*(...
...
KernelVyyz(Index2)=-cosd(FaiI(Index2))*(...
    ((1+3*R2+3*R2^2)/((1+R2)^3))- ...
    ((1+3*R1+3*R1^2)/((1+R1)^3)));
